...
class EldoradoApplicationTests {
	...
	@Test
	public void validProductDetailsInput(){
		Product product=new Product("add87@","","Accessories",-1,-1,"http://www.example.com/%26here.html","http://www.example.com/ %26here.html","http://www.example.com/ %26here.html");
...
//		assertTrue(actualMessage.contains(expectedMessage));
		assertThrows(ConstraintViolationException.class,()->productController.validateInputProduct(product));
	}
	...
	public void validProductPdfLinks(){
		String link = "http://www.example.com/ %26here.html";
		Exception exception = assertThrows(InvalidEntryException.class,()->productService.validatePdfLinks(link));
